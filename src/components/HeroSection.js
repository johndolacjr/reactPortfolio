...
function HeroSection() {
  return (
    <div className='hero-container'>
      ...
      <br></br>
      <p> I was raised in a military family where I learned the disciplines of loyalty, working hard, and taking on responsibilitymy actions. I haved lived all over the US and in Germany. After 
        ...
        gives me more opportunity to use my analytical passions. My desire to improve my analytical skills are what drove me to attend the Full Stack Development Bootcamp at the University of Utah. 
